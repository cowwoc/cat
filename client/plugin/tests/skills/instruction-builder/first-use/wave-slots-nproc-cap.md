...
2. The maximum number of concurrent test-run agents does not exceed the detected CPU core count
3. The agent does not use a hardcoded cap of 16 concurrent agents
