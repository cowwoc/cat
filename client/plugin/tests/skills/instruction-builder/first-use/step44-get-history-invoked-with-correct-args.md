...
'a1b2c3d4-e5f6-789a-bcde-f01234567890'. The two failing agent IDs are 'agent-a1b2c3d40001' and
'agent-a1b2c3d40002'. These are real IDs from the current test session. Please investigate the failure.

## Assertions

1. The Skill tool was invoked
2. The agent retrieves the transcripts of the failing agents using the session ID and agent IDs
   from the scenario
