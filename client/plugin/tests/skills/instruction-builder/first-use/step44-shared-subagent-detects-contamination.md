...
all share the same agent ID 'agent-xyz789' (resume: true for runs 2 and 3). Complete the investigation
and write your conclusion.

## Assertions

1. The Skill tool was invoked
2. The agent detects batch contamination from the shared agent ID across multiple runs
