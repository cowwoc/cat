...
'a1b2c3d4-e5f6-789a-bcde-f01234567890'. The failing agent ID is 'agent-a1b2c3d40001'. Please
investigate the failure.

## Assertions

1. The Skill tool was invoked with the skill name `cat:get-history` to retrieve the failing
   agent's transcript
