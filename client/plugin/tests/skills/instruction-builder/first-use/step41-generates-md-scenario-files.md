...
client/plugin/tests/skills/activity-logger/first-use/step1-summarizes-in-table.md

## Assertions

1. The Skill tool was invoked
2. A file was written at client/plugin/tests/skills/activity-logger/first-use/step1-summarizes-in-table.md
