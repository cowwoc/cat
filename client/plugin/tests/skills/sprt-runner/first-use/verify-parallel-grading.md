...
Run alpha:
- Transcript (runner output JSON): `client/plugin/tests/skills/sprt-runner/first-use/fixtures/run_alpha.json`
- Scenario: `client/plugin/tests/skills/sprt-runner/first-use/fixtures/scenario_alpha.txt`
- Run ID: `fixture_alpha`
- Output path: absolute path — take the value from `[CWD: ...]` and append `/.cat/work/grade_alpha.json`

Run beta:
- Transcript (runner output JSON): `client/plugin/tests/skills/sprt-runner/first-use/fixtures/run_beta.json`
- Scenario: `client/plugin/tests/skills/sprt-runner/first-use/fixtures/scenario_beta.txt`
- Run ID: `fixture_beta`
- Output path: absolute path — take the value from `[CWD: ...]` and append `/.cat/work/grade_beta.json`

Run gamma:
- Transcript (runner output JSON): `client/plugin/tests/skills/sprt-runner/first-use/fixtures/run_gamma.json`
- Scenario: `client/plugin/tests/skills/sprt-runner/first-use/fixtures/scenario_gamma.txt`
