...
`tests/` directory is auto-generated by `SprtRunner`; do not edit it manually.
...
Java/TestNG tests may validate engine code that processes, packages, routes, or loads skills, but they must not
