...
- Take the relative path within the repository (e.g., `client/plugin/skills/common/foo/SKILL.md`)
- Prepend `${WORKTREE_PATH}/` to form the absolute path (e.g., `${WORKTREE_PATH}/client/plugin/skills/common/foo/SKILL.md`)
...
cat client/plugin/skills/common/foo/SKILL.md

# WRONG: Absolute /workspace path bypasses worktree isolation entirely
cat /workspace/client/plugin/skills/common/foo/SKILL.md

# WRONG: Constructing path from the wrong root
SKILL_PATH="/workspace/client/plugin/skills/common/foo/SKILL.md"
```

**Example — CORRECT:**
```bash
# CORRECT: Absolute path rooted at the worktree
cat "${WORKTREE_PATH}/client/plugin/skills/common/foo/SKILL.md"

# CORRECT: Construct the path explicitly from WORKTREE_PATH
SKILL_PATH="${WORKTREE_PATH}/client/plugin/skills/common/foo/SKILL.md"
