...
cd "${WORKTREE_PATH}" && git add "${WORKTREE_PATH}/client/plugin/skills/common/foo/SKILL.md" && git commit -m "feature: add thing"
...
See `/cat:rm` for detailed guidance on safe directory removal.
