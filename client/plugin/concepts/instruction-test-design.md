...
- **Skill tests** (`client/plugin/tests/skills/`) — verify skill selection and execution
- **Rule tests** (`client/plugin/tests/rules/`) — verify behavioral rules are followed
...
Complete examples for `grep-and-read` stored in `client/plugin/tests/skills/grep-and-read/`:
