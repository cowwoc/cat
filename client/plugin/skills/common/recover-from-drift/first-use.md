...
This variant runs as a lightweight Haiku agent and is invoked by other skills — it is not user-invocable.
...
"${CAT_PLUGIN_ROOT}/client/bin/get-output" recover-from-drift-agent
```
