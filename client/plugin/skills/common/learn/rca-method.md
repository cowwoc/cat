...
causal_barrier_analysis:
  ...
  barriers:
    - barrier: "Documentation in project instructions"
      existed: true
...
- **`biased_rca` pipeline-section specificity:** A modification to a pipeline artifact file satisfies the
  ...
  conclusion-summary, archival-record, or prior-output section of the file. A file that contains both
...
| `plugin_rules` | Failure related to plugin behavioral rules (project instructions, rules/) |
