...
# - client/plugin/skills/common/work-implement/first-use.md (Step 4: pre-implementation gate)
# - client/plugin/skills/common/work-merge/first-use.md (Step 12: approval gate)
