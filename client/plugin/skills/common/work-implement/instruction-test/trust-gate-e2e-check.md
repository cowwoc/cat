...
### Gate 1 — Pre-Implementation Review (work-implement Step 4)
...
### Gate 2 — Pre-Merge Approval Gate (work-merge Step 12)
...
### Gate 1 — Pre-Merge Approval Gate only (work-merge Step 12)
...
### Auto-merge path (work-merge Step 12)
...
- [ ] Merge proceeds automatically — no structured approval tool is invoked.
