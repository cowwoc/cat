...
See `${CAT_PLUGIN_ROOT}/concepts/version-paths.md` for version path conventions used throughout this skill.
See `${CAT_PLUGIN_ROOT}/concepts/work-decomposition.md` for the full execution hierarchy, agent execution model, and
