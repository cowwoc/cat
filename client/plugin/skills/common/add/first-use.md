...
- Key skill dependencies by scanning for patterns like `client/plugin/skills/{common,<runtime>}/<name>/` or "modify <name> skill"
...
```bash
CLIENT_BIN="${CAT_PROJECT_DIR}/client/cli/target/jlink/bin"
