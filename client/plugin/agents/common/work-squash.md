...
AUTO_CLOSE_OUTPUT=$("${CAT_PLUGIN_DATA}/client/bin/auto-close-index" "${WORKTREE_PATH}" "${BRANCH}")
...
```bash
"${CAT_PLUGIN_DATA}/client/bin/git-squash" "${TARGET_BRANCH}" "${PRIMARY_COMMIT_MESSAGE}" "${WORKTREE_PATH}"
SQUASH_EXIT=$?
```
