...
public interface ClaudeHook extends ClaudePluginScope
{
   ...
   * @throws IllegalStateException if this scope is closed
   */
  String getStringInput(String... keys);
   ...
   * @throws IllegalStateException if this scope is closed
   */
  String getStringInput(String key, String defaultValue);
   ...
   * @throws IllegalStateException if this scope is closed
   */
  boolean getBooleanInput(String key, boolean defaultValue);
   ...
   * @throws IllegalStateException if this scope is closed
   */
  JsonNode getObjectInput(String key);
