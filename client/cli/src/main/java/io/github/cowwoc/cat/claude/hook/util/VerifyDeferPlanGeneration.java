 ...
 * Asserts that:
 * <ol>
 *   <li>{@code client/plugin/skills/common/add/first-use.md} does NOT contain a {@code cat:plan-builder}
 *       invocation</li>
 *   <li>{@code client/plugin/skills/common/add/first-use.md} contains the lightweight plan generation block
 *       ({@code planTempFile=$(mktemp})</li>
 *   <li>{@code client/plugin/skills/common/work-implement/first-use.md} contains the {@code hasSteps}
 *       check</li>
 *   <li>{@code client/plugin/skills/common/work-implement/first-use.md} invokes {@code cat:plan-builder}</li>
 * </ol>
 * <p>
...
public final class VerifyDeferPlanGeneration
{
  ...
  public static int run(JvmScope scope, String[] args, PrintStream out)
  {
    ...
    Path addSkill = projectRoot.resolve("client/plugin/skills/common/add/first-use.md");
    Path workImplementSkill =
      projectRoot.resolve("client/plugin/skills/common/work-implement/first-use.md");
    ...
    try
    {
      // Read each file once; null means file is missing
      String addContent;
      if (Files.notExists(addSkill))
        addContent = null;
      else
        addContent = Files.readString(addSkill);
      ...
      else if (addContent.contains("planTempFile=$(mktemp"))
      {
