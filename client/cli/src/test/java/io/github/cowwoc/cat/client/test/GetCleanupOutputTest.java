...
import io.github.cowwoc.cat.claude.hook.skills.GetCleanupOutput.Lock;
import io.github.cowwoc.cat.claude.hook.skills.GetCleanupOutput.RemovedCounts;
import io.github.cowwoc.cat.claude.hook.skills.GetCleanupOutput.StaleRemote;
import io.github.cowwoc.cat.claude.hook.skills.GetCleanupOutput.Worktree;
import io.github.cowwoc.cat.claude.hook.skills.GetCleanupOutput.WorktreeToRemove;
...
import static io.github.cowwoc.cat.client.test.TestUtils.deleteDirectoryRecursively;
...
public class GetCleanupOutputTest
{
  ...
  public void lockFileWithRecentMtimeReturnsRecentAge() throws IOException
  {
    ...
    try
    {
      ...
      requireThat(age, "age").isLessThan(io.github.cowwoc.cat.claude.hook.util.IssueLock.STALE_LOCK_THRESHOLD);
    }
    finally
    {
  ...
  public void lockFileWithOldMtimeReturnsStaleAge() throws IOException
  {
    ...
    try
    {
      ...
      requireThat(age, "age").
        isGreaterThanOrEqualTo(io.github.cowwoc.cat.claude.hook.util.IssueLock.STALE_LOCK_THRESHOLD);
    }
    finally
    {
      Files.deleteIfExists(lockFile);
