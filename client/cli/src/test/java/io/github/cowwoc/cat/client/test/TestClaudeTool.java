...
public final class TestClaudeTool extends AbstractClaudeTool
{
   ...
   */
  public TestClaudeTool(Path claudeProjectPath, Path claudePluginRoot)
  {
   ...
   */
  public TestClaudeTool(Path claudeProjectPath, Path claudePluginRoot, Path workDir)
  {
