...
import io.github.cowwoc.cat.claude.hook.bash.post.DetectFailures;
...
public final class DetectFailuresTest
{
  ...
  public void exitCodeZeroReturnsAllow()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("mvn test", Path.of(""), "test-session", toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
  ...
  public void nonZeroExitCodeWithoutFailurePatternReturnsAllow()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("nonexistent-cmd", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void buildFailedPatternInStdoutTriggersWarn()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("mvn verify", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void nonTestRunnerCommandWithFailureOutputReturnsAllow()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("./run-tests.sh", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void compilerCommandWithErrorOutputReturnsAllow()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("javac Main.java", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void jvmCommandWithExceptionOutputReturnsAllow()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("java -jar app.jar", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void serverScriptWithFatalOutputReturnsAllow()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("start-server.sh", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void gitCommandWithFatalOutputReturnsAllow()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("git status", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void gitDiffWithFailureKeywordsInOutputReturnsAllow()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("git diff", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void catCommandWithFailureKeywordsInOutputReturnsAllow()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("cat plan.md", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void getOutputGetDiffWithFailureKeywordsReturnsAllow()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("get-output get-diff", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void batsTestRunnerFailureTriggersWarn()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("bats tests/", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void gradleTestFailureTriggersWarn()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("gradle test", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void patternMatchingIsCaseInsensitiveForTestRunners()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("mvn test", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void npmRunTestFailureTriggersWarn()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("npm run test", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  public void nullStdoutAndStderrDefaultToEmpty()
  {
    ...
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("some-command", Path.of(""), "test-session",
      toolResult))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
  ...
  {
    try (TestClaudeHook scope = TestUtils.bashHookWithToolResult("some-command", Path.of(""), "test-session", null))
    {
      DetectFailures handler = new DetectFailures(scope);
      BashHandler.Result result = handler.check();
