...
public final class VerifyDeferPlanGenerationTest
{
  ...
  {
    Path file = projectRoot.resolve("client/plugin/skills/common/add/first-use.md");
  ...
  {
    Path file = projectRoot.resolve("client/plugin/skills/common/work-implement/first-use.md");
    Files.createDirectories(file.getParent());
    Files.writeString(file, content);
  }
