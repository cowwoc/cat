...
public final class WarnFileExtractionTest
{
  ...
  public void tarExtractionCommandIsWarned() throws IOException
  {
    ...
    {
      BashHandler.Result result = check(scope, "tar -xzf archive.tar.gz");
  ...
  public void tarListCommandIsNotWarned() throws IOException
  {
    ...
    try (TestClaudeTool scope = new TestClaudeTool(tempDir, tempDir))
    {
      BashHandler.Result result = check(scope, "tar -tzf archive.tar.gz");
  ...
  public void unzipCommandIsWarned() throws IOException
  {
    ...
    try (TestClaudeTool scope = new TestClaudeTool(tempDir, tempDir))
    {
      BashHandler.Result result = check(scope, "unzip archive.zip");
  ...
  public void gunzipCommandIsWarned() throws IOException
  {
    ...
    try (TestClaudeTool scope = new TestClaudeTool(tempDir, tempDir))
    {
      BashHandler.Result result = check(scope, "gunzip file.gz");
  ...
  public void nonExtractionCommandIsNotWarned() throws IOException
  {
    ...
    try (TestClaudeTool scope = new TestClaudeTool(tempDir, tempDir))
    {
      BashHandler.Result result = check(scope, "ls -la");
  ...
  public void tarCreateCommandIsNotWarned() throws IOException
  {
    ...
    try (TestClaudeTool scope = new TestClaudeTool(tempDir, tempDir))
    {
      BashHandler.Result result = check(scope, "tar -czf backup.tar.gz .");
  ...
  private static BashHandler.Result check(TestClaudeTool scope, String command) throws IOException
  {
    ...
    {
      return new WarnFileExtraction(commandScope).check();
    }
  }
}
