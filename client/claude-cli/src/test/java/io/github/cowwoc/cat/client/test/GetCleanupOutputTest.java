...
import io.github.cowwoc.cat.tool.skills.GetCleanupOutput.Lock;
import io.github.cowwoc.cat.tool.skills.GetCleanupOutput.RemovedCounts;
import io.github.cowwoc.cat.tool.skills.GetCleanupOutput.StaleRemote;
import io.github.cowwoc.cat.tool.skills.GetCleanupOutput.Worktree;
import io.github.cowwoc.cat.tool.skills.GetCleanupOutput.WorktreeToRemove;
...
public class GetCleanupOutputTest
{
  ...
  public void lockFileWithRecentMtimeReturnsRecentAge() throws IOException
  {
    ...
    try
    {
      ...
      requireThat(age, "age").isLessThan(io.github.cowwoc.cat.tool.util.IssueLock.STALE_LOCK_THRESHOLD);
    }
    finally
    {
  ...
  public void lockFileWithOldMtimeReturnsStaleAge() throws IOException
  {
    ...
    try
    {
      ...
      requireThat(age, "age").
        isGreaterThanOrEqualTo(io.github.cowwoc.cat.tool.util.IssueLock.STALE_LOCK_THRESHOLD);
    }
    finally
    {
      Files.deleteIfExists(lockFile);
