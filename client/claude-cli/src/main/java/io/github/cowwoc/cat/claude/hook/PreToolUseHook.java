...
public final class PreToolUseHook implements HookHandler
{
  ...
  public PreToolUseHook(ClaudeHook scope)
  {
    ...
    this.handlers = List.of(
      new BlockGitUserConfigChange(scope),
      ...
      new BlockWrongBranchCommit(scope),
      new ComputeBoxLines(scope),
      new RemindGitSquash(scope),
      new ValidateCommitType(scope),
      new ValidateGitFilterBranch(scope),
      new ValidateGitOperations(scope),
      new WarnFileExtraction(scope),
      new WarnMainWorkspaceCommit(scope),
      new WarnPipedWithoutTee(scope));
  }
