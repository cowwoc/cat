...
public final class BlockWorktreeIsolationViolation implements BashHandler
{
  ...
  /**
   * Creates a new handler with an injectable environment lookup.
   *
   * @param scope     the hook scope providing access to shared resources
   * @param envLookup the environment lookup used for shell variable expansion
   * @throws NullPointerException if {@code scope} or {@code envLookup} are null
   */
  private BlockWorktreeIsolationViolation(ClaudeHook scope, Function<String, String> envLookup)
  {
