...
public final class ProgressBanner implements SkillOutput
{
   ...
   *
   * @param scope the CliTool providing display utilities
   * @throws NullPointerException if {@code scope} is null
   */
  public ProgressBanner(CliTool scope)
  {
   ...
   * Invoked as: java -cp hooks.jar io.github.cowwoc.cat.tool.skills.ProgressBanner [args]
   *
