 ...
 * <p>
 * Each handler performs a specific task during session initialization and returns context to inject into
 * the conversation and/or messages for stderr.
 */
@FunctionalInterface
public interface SessionStartHandler
{
   ...
   *
   * @param additionalContext context to inject into the conversation
