...
"${CLAUDE_PLUGIN_ROOT}/client/bin/instruction-test-runner" init-sprt \
  ".cat/work/sprt-state.json" '["tc1","tc2"]' "/dev/null" "claude-sonnet-4-5-20251001"
```
...
2. The agent's text response includes the value `claude-sonnet-4-5-20251001` for `model_id`
