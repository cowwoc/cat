...
- **TC9_det_1** (string_match): Invocation includes the correct skill name
...
- **TC9_sem_1** Agent handles cat:get-history-agent failures gracefully and continues with other agents
