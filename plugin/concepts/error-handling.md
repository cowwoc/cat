...
**Why this matters:**
- Skills contain validation logic (e.g., `cat:instruction-builder-agent` uses its own validation protocol for equivalence)
...
Subagent: "FAILED: recursion issues with cat:instruction-builder-agent"
