...
```
FAIL: <output skill="delegate"> tag not found.
This output is generated by the delegate preprocessor directive.
If this section is empty, the hooks may not be loaded (restart Claude Code) or the wiring may be missing.
