...
cd /workspace && git worktree remove ${HOME}/.cat/worktrees/issue-name --force

# DANGEROUS - removing worktree while inside it
# pwd: ${HOME}/.cat/worktrees/issue-name
git worktree remove ${HOME}/.cat/worktrees/issue-name --force  # Shell breaks!
```
...
git -C /workspace worktree remove ${HOME}/.cat/worktrees/task --force

# RIGHT - cd changes the shell's cwd
cd /workspace && git worktree remove ${HOME}/.cat/worktrees/task --force
```
