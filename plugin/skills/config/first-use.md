...
```
FAIL: SKILL OUTPUT CONFIG BOXES not provided by the get-config-output preprocessor directive.
...
Use the **CURRENT_SETTINGS** box from SKILL OUTPUT CONFIG BOXES (provided by get-config-output preprocessor).
