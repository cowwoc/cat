...
- **Pass rates are NOT SPRT decisions** — a 100% pass rate over 5 trials does not mean the test case has been
  ...
  SPRT Accept/Reject decisions are only made by the instruction-builder's Step 6 pipeline.
...
- `cat:instruction-builder` - Create or update skills with compliance-tested patterns
