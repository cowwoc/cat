...
`skill-loader` instructions into all subagents at startup, most agents no longer need `skills:`
...
skills in the frontmatter, the agent has this knowledge from the start without calling skill-loader.
