...
3. **Note cross-file impacts**: Identify how changes across files collectively fulfill or break requirements —
   partial changes in isolation may not satisfy a requirement.
