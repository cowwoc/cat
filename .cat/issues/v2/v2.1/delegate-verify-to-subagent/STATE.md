...
- **Resolution:** implemented - Created work-verify.md agent definition that accepts issue metadata, writes detailed
  criterion analysis to .cat/verify/criteria-analysis.json and E2E test output to
  .cat/verify/e2e-test-output.json, and returns compact JSON to parent. Restructured Step 4 in
