...
- `.cat/PROJECT.md` (project config)
- `.cat/conventions/*.md` (language conventions)
- `.cat/issues/v1/**/PLAN.md` and `STATE.md` (v1 issues)
- `.cat/issues/v2/**/PLAN.md`, `STATE.md`, `CHANGELOG.md` (v2 issues)
- `plugin/agents/*.md` (stakeholder agents)
- `plugin/concepts/*.md` (concept docs)
- `plugin/skills/*/*.md` (skill definitions)

Exclude: `.cat/backups/`, `.worktrees/`, `node_modules/`, `.git/`
