...
- `plugin/agents/stakeholder-*.md` — update `.cat/review/` relative paths to `${WORKTREE_PATH}/.cat/review/`
...
- Update all `plugin/agents/stakeholder-*.md`: replace `.cat/review/<stakeholder>-concerns.json`
  with `${WORKTREE_PATH}/.cat/review/<stakeholder>-concerns.json`
