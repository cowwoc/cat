...
- `.cat/issues/v2/v2.1/ci-build-jlink-bundle/PLAN.md` - Remove jlink-config.sh references
- `.cat/issues/v2/v2.1/developer-local-bundle-rebuild/PLAN.md` - Remove jlink-config.sh references
...
3. **Update issue PLANs:** Remove stale references to jlink-config.sh in ci-build-jlink-bundle and
   ...
   - Files: `.cat/issues/v2/v2.1/ci-build-jlink-bundle/PLAN.md`,
