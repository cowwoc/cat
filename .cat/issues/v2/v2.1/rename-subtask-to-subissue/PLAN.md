...
- `.cat/issues/v2/v2.1/migrate-python-to-java/STATE.md` - Rename "Sub-task" headers and "sub-tasks" text
- `.cat/issues/v2/v2.1/rename-task-to-issue/STATE.md` - Rename "Sub-task" headers
- `.cat/issues/v2/v2.1/compress-md-files/STATE.md` - Rename "Sub-task" and "sub-tasks"
- `.cat/issues/v2/v2.1/compress-skills-md/STATE.md` - Rename "subtasks"
- `.cat/issues/v2/v2.1/fix-decomposed-parent-completion/PLAN.md` - Rename all subtask references
- `.cat/issues/v2/v2.1/skip-decomposed-parents-in-discovery/PLAN.md` - Rename subtask references
- `.cat/issues/v2/v2.1/skip-decomposed-parents-in-discovery/STATE.md` - Rename subtask references
- `.cat/issues/v2/v2.1/migrate-to-silent-preprocessing/PLAN.md` - Rename section header
- `.cat/issues/v2/v2.1/migrate-to-silent-preprocessing/STATE.md` - Rename section header and table
- `.cat/issues/v2/v2.1/compress-commands-md/PLAN.md` - Rename "subtask" reference
- `.cat/issues/v2/v2.1/compress-lang-md/PLAN.md` - Rename "subtask" reference
- `.cat/issues/v2/v2.1/compress-skills-batch-[1-5]/PLAN.md` - Rename "subtask" references
- `.cat/issues/v2/v2.1/compress-stakeholders-md/PLAN.md` - Rename "subtask" reference
- `.cat/issues/v2/v2.1/compress-concepts-md/PLAN.md` - Rename "subtask" reference
- `.cat/issues/v2/v2.1/compress-templates-md/PLAN.md` - Rename "subtask" reference

### Category 5: Historical/Changelog Files
- `CHANGELOG.md` - Rename "subtasks"/"sub-task-based" references
- `.cat/issues/v1/v1.0/CHANGELOG.md` - Rename "subtasks" reference
- `.cat/issues/v1/v1.2/CHANGELOG.md` - Rename "subtasks"/"sub-task-based"
- `.cat/issues/v1/v1.2/auto-decomposition-parallel-execution/PLAN.md` - Rename
- `.cat/issues/v2/v2.0/STATE.md` - Rename "subtasks" reference
- `.cat/issues/v2/v2.0/suggest-decomposition-at-soft-limit/PLAN.md` - Rename "sub-tasks"

### Category 6: Retrospective Files (JSON)
- `.cat/retrospectives/index.json` - Rename subtask references
- `.cat/retrospectives/mistakes-2026-01.json` - Rename subtask references
- `.cat/retrospectives/mistakes-2026-02.json` - Rename subtask references
- `.cat/retrospectives/retrospectives-2026-01.json` - Rename subtask reference

### NOT modified (leave "wave" as-is)
- `.cat/issues/v1/v1.10/parallel-execution-naming/PLAN.md` - Historical closed issue describing the old rename
