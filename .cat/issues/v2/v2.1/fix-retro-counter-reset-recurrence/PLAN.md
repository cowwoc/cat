...
`tempDir.resolve(".cat/retrospectives")`, write `index.json` with `Files.writeString`,
...
Use the missing-retrospectives-directory error path: create tempDir with NO `.cat/retrospectives`
