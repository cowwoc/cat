...
## Goal
Search all .cat/issues/**/*.md files for deprecated STATE.md fields ('Last Updated', etc.) and update
...
## Files to Modify
- All .md files under `.cat/issues/` that contain deprecated STATE.md field examples
...
- Add or update schema documentation listing deprecated fields vs current fields with removal timeline
  - Files: `.cat/conventions/state-schema.md` or similar
- Update post-condition "No deprecated field names appear in example STATE.md content in documentation or plan files"
  ...
  - Files: `.cat/issues/v2/v2.1/audit-state-md-examples-schema/PLAN.md`
- Update E2E criterion "Grep for deprecated field names across .cat/issues/ returns no hits" to explicitly
...
## Post-conditions
- [ ] All STATE.md examples in .cat/ use only current valid fields
...
- [ ] E2E: Grep for deprecated field names across .cat/issues/ returns no hits in example/documentation
