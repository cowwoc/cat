...
The full analysis is written to `${WORKTREE_PATH}/.cat/rebase-impact-analysis.md`.
...
```json
{
  ...
  "analysis_path": "${WORKTREE_PATH}/.cat/rebase-impact-analysis.md"
}
```
...
- Add a `## Manual E2E Verification` section to `plugin/skills/rebase-impact-agent/first-use.md` that
  ...
  4. Verify `${WORKTREE_PATH}/.cat/rebase-impact-analysis.md` is written.
...
- [ ] Analysis details are written to `${WORKTREE_PATH}/.cat/rebase-impact-analysis.md`
