...
## Target State
Worktrees are created at `${CLAUDE_PROJECT_DIR}/.cat/worktrees/` grouping all CAT-managed
directories under `.cat/`.
...
- [ ] Code quality improved - all CAT artifacts consolidated under `.cat/`

- [ ] All references to `.worktrees/` updated to `.cat/worktrees/`
- [ ] All tests pass
