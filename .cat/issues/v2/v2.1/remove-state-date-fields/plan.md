...
- `.cat/issues/v2/v2.1/*/STATE.md` — removed by migration script (all existing open and closed issues)
...
- [ ] No STATE.md file under `.cat/issues/` contains `Last Updated` or `Completed`
