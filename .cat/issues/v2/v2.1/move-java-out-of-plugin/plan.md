...
- `.cat/conventions/java.md` - Update `cd plugin/hooks/java` → `cd hooks`
...
- `.cat/issues/v2/v2.1/unify-project-hooks/PLAN.md`
- `.cat/issues/v2/v2.1/unify-sessionstart-hooks/PLAN.md`
- `.cat/issues/v2/v2.1/unify-stop-sessionend-hooks/PLAN.md`
- `.cat/issues/v2/v2.1/unify-pretooluse-hooks/PLAN.md`
- `.cat/issues/v2/v2.1/unify-posttooluse-hooks/PLAN.md`
- `.cat/issues/v2/v2.1/unify-userpromptsubmit-hooks/PLAN.md`
- `.cat/issues/v2/v2.1/ci-build-jlink-bundle/PLAN.md`
- `.cat/issues/v2/v2.1/developer-local-bundle-rebuild/PLAN.md`
- `.cat/issues/v2/v2.1/migrate-python-tests/PLAN.md`
- `.cat/issues/v2/v2.1/migrate-token-counting/PLAN.md`
...
2. **Step 2: Update direct references in active files**
   - Files: `CLAUDE.md`, `.cat/conventions/java.md`, `plugin/skills/delegate/content.md`,
