...
git checkout --ours .cat/claim-index.db    # Pick one side
# OR
git checkout --theirs .cat/claim-index.db
...
| `.cat/claim-index.db` | Create | SQLite database (git-tracked) |
