...
The git-squash skill reads `### Squash Policy` from `.cat/PROJECT.md` but there is no interactive way to set it.
...
- .cat/PROJECT.md — written by wizard when policy is selected
