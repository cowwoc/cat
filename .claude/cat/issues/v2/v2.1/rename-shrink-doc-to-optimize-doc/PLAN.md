...
- `.claude/cat/issues/v2/v2.1/shrink-doc-token-metrics/PLAN.md` — update references
- `.claude/cat/issues/v2/v2.1/optimize-shrink-doc-workflow/PLAN.md` — update references
- `.claude/cat/issues/v2/v2.3/compress-*/PLAN.md` — update references in active compression issues
- `.claude/cat/issues/v2/v2.1/STATE.md` — update pending issue names
...
- Exclude closed issue directories (`.claude/cat/issues/` files under Issues Completed)
