...
- `plugin/skills/work-merge/first-use.md` — update REBASE_CONFLICT handler table entry and add
...
- Update REBASE_CONFLICT table row in work-merge/first-use.md to mention backup_branch deletion
